      ...
      <div className="mx-auto max-w-5xl">
        <header className="mb-8">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500 dark:text-slate-400">
            Keep your contact details current and make your company page useful
            to candidates.
          </p>
        </header>
        <div className="grid gap-6 lg:grid-cols-[17rem_1fr] lg:items-start">
          <aside className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950">
            <div className="flex items-center gap-3 lg:block">
              {user?.avatarUrl ? (
                <Image
                  ...
                  width={64}
                  height={64}
                  className="h-16 w-16 rounded-2xl object-cover ring-4 ring-orange-50 dark:ring-orange-950/40"
                />
              ) : (
                <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-orange-100 text-orange-700 ring-4 ring-orange-50 dark:bg-orange-950/50 dark:text-orange-300 dark:ring-orange-950/40">
              ...
              <div className="min-w-0 lg:mt-4">
                ...
                <span className="mt-3 inline-flex rounded-full bg-slate-100 px-2.5 py-1.5 text-xs font-semibold text-slate-700 capitalize dark:bg-slate-800 dark:text-slate-300">
            ...
            <nav
              className="mt-6 hidden space-y-1 border-t border-slate-100 pt-4 lg:block dark:border-slate-800"
              aria-label="Profile sections"
            >
              <a
                href="#personal"
                className="block rounded-lg bg-orange-50 px-3 py-2 text-sm font-semibold text-orange-700 dark:bg-orange-950/40 dark:text-orange-300"
              >
                Personal information
              </a>
              <a
                href="#company"
                className="block rounded-lg px-3 py-2 text-sm font-medium text-slate-600 hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-slate-900"
              >
                Company details
              </a>
              <a
          ...
          <div className="min-w-0 space-y-6">
            <section
              id="personal"
              className="scroll-mt-24 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6 dark:border-slate-800 dark:bg-slate-950"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    This is how candidates and teammates will see you.
                  </p>
                </div>
              ...
              <button
                ...
                className="mt-5 inline-flex min-h-10 items-center gap-2 rounded-xl bg-orange-600 px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-orange-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3">
                  <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-orange-50 text-orange-700 dark:bg-orange-950/50 dark:text-orange-300">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                      {company
                        ? "Tell candidates what makes your team special."
              ...
              <form onSubmit={saveCompany} className="mt-4 space-y-4">
                ...
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-200">
                  ...
                  <select
                    ...
                    disabled={Boolean(company) && !canEditCompany}
                    className="mt-1.5 w-full rounded-xl border border-slate-300 bg-transparent px-3 py-2.5 text-sm transition outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 dark:border-slate-700"
                  >
  ...
  return (
    <label className="block text-sm font-medium text-slate-700 dark:text-slate-200">
      ...
      <input
        ...
        disabled={disabled}
        required={required}
        className="mt-1.5 w-full rounded-xl border border-slate-300 bg-transparent px-3 py-2.5 text-sm transition outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 disabled:bg-slate-100 disabled:text-slate-500 dark:border-slate-700 dark:disabled:bg-slate-900"
      />
    </label>
  );
}
