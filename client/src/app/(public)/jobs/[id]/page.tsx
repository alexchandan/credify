        ...
        <div className="mt-6 grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <aside className="rounded-xl border border-slate-200/90 bg-white p-6 shadow-sm lg:sticky lg:top-24 dark:border-white/10 dark:bg-slate-900">
            ...
            {job.status !== "published" ? (
              ...
              <div
                role="status"
                className="mt-4 rounded-xl border border-emerald-300/40 bg-emerald-50/90 p-5 text-sm text-emerald-900 shadow-sm dark:border-emerald-500/30 dark:bg-emerald-950/40 dark:text-emerald-200"
              >
                <div className="flex items-center gap-2">
                  <CheckCircle2
                ...
                <p className="mt-2 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                  ...
                  hiring team has been notified and you can track your status
                  live.
                </p>
                <Link
                  href="/candidate/applications"
                  className="mt-4 inline-flex h-9 w-full items-center justify-center gap-1.5 rounded-lg bg-emerald-600 px-4 text-xs font-semibold text-white shadow-xs transition hover:bg-emerald-500"
                >
              ...
              <>
                ...
                <textarea
                  ...
                  maxLength={3000}
                  rows={5}
                  placeholder="Share a brief introduction or highlight why your experience aligns with this position..."
                  className="mt-1.5 w-full resize-y rounded-xl border border-slate-300 p-3 text-xs leading-relaxed text-slate-900 transition outline-none placeholder:text-slate-400 focus:border-cyan-600 focus:ring-2 focus:ring-cyan-500/20 dark:border-slate-700 dark:bg-slate-950 dark:text-white dark:focus:ring-cyan-500/30"
                />
                {applicationError && (
                  <div
                    role="alert"
                    className="mt-3 rounded-xl border border-rose-200 bg-rose-50/90 p-3 text-xs text-rose-700 dark:border-rose-900/50 dark:bg-rose-950/40 dark:text-rose-300"
                  >
                    <p className="font-semibold">{applicationError}</p>
                    {needsResume && (
                      <Link
                        href="/candidate/profile"
                        className="mt-1.5 inline-flex items-center gap-1 font-bold text-cyan-700 underline hover:no-underline dark:text-cyan-400"
                      >
                        Upload your resume to your profile &rarr;
                      </Link>
                    )}
                  </div>
                )}
