  ...
  return (
    ...
    >
      <div
        ...
        className="mt-6 grid grid-cols-2 gap-1.5 rounded-xl border border-slate-200/90 bg-slate-100/70 p-1.5 text-sm font-medium dark:border-slate-800 dark:bg-slate-900/80"
      >
        <button
          type="button"
          role="radio"
          ...
          className={`rounded-lg px-3 py-2.5 transition ${
            role === "candidate"
              ? "bg-linear-to-r from-cyan-600 to-cyan-700 font-semibold text-white shadow-sm shadow-cyan-600/20 dark:from-cyan-500 dark:to-cyan-600 dark:text-slate-950"
